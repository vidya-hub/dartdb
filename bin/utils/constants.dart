...
class Constants {
  ...
  static String GET_DATABASES = r'list databases';
  static String GET_COLLECTIONS = r'list collections from (\w+)';
  static String CREATE_COLLECTION =
      r'^create collection (\w+)\.(\w+)(?:\.schema\(\s*params:\s*\[(.*?)\],\s*types:\s*\{(.*?)\}\s*\))?$';
